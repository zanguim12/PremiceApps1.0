...
export class ArticleService {
    ...
    getArticlesMini() {
        return Promise.resolve(this.getArticleData().slice(0, 5));
    }

    getArticlesSmall() {
        return Promise.resolve(this.getArticleData().slice(0, 10));
    }

    getArticle() {
        return Promise.resolve(this.getArticleData());
    }

   /* getArticlesWithOrdersSmall() {
        return Promise.resolve(this.getArticleWithOrdersData().slice(0, 10));
    }

    getArticlesWithOrders() {
        return Promise.resolve(this.getArticleWithOrdersData());
    }*/
};
